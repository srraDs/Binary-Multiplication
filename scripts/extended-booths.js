 ...
 *  extendedBoothsDescription  790
 * 
 */
function extendedBoothsDesc() {
 ...
 */
function extendedBoothsDisplayEqual(
	multiplicandBin,
	multiplierBin,
	multiplicand,
	multiplier
 ...
 */
function extendedBoothsDisplayFirstStep() {
 ...
 */
function extendedBoothsDisplaySecStep() {
 ...
 */
function extendedBoothsDisplayThirdStep() {
	appendTemplate(
...
function extendedBoothsPencil(
	...
	if (displayNumber == 0) {
		...
		if (displayNumber == extendedBoothsArray.length + 1) {
			 ...
			 */
			if (currentCarry >= 1) {
				$('#extended-booths-product-carry-over').text(toBinaryRaw(currentCarry));
			}
		}

		/* Update the carry-over after summation of each bit column. */
		$('#extended-booths-carry-over').text(toBinaryRaw(currentCarry));
