...
/**
 * boothsInit changed in 579, 741, 790
 * 
 */
function boothsInitialize() {
	$('#algo-name').hide();
 ...
 * 
 * boothsDescription changed in 726
 */
function boothsDesc() {
 ...
 * boothsInitRecodeMap changed in 794
 */ 
function boothsInitRecodeTable() {
 ...
 * 
 */
function boothsTotSteps(multiplicandBin, multiplierBin) {
 ...
 */
/**
 *  boothsDisplayEqualizedBits 595
 * 
 */
function boothsDisplayEqualBits(
	multiplicandBin,
	multiplierBin,
	multiplicand,
	multiplier
 ...
 */
function boothsDisplayFirstStep() {
 ...
 * boothsDisplayStepC2
 */
function boothsDisplaySecondStep() {
	appendTemplate(
 ...
 * 
 * boothsGoToStep0 726, 698
 * 
 */
function boothsGoToSZeroStep() {
	initStepNumber(0);
	boothsDesc();
...
function boothsGoTo(stepNumber, multiplicandBin, multiplierBin) {
	...
	boothsInitialize();
	initStepNumber(1);
	boothsTotSteps(multiplicandBin, multiplierBin);
