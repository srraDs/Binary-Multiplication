...
/**
 * pencilDescription changed in 571 check 
 */
function pencilDesc() {
 ...
 * 
 * 
 * pencilTotalSteps changed in 614 and 590
 */
function pencilTotSteps(multiplicandBin, multiplierBin) {
...
/**
 *
 * pencilDisplayEqualizedBits 453
 */
function pencilDisplayEqualBits(
	multiplicandBin,
	multiplierBin,
	multiplicand,
	multiplier
...
function pencilDisplayStepC() {
	...
	incrementStepNumber(); // increments
}
 ...
 function pencilPencil(
	...
	if (displayNumber == 0) {
		...
		if (displayNumber == multiplierArray.length + 1 + offset) {
			...
			appendRow('pencil-pencil-table', `${pencilProdRow}`);
		} else if (displayNumber == multiplierArray.length + numBitsProduct + offset) {
			/*
...
function pencilGoTo(stepNumber, multiplicandBin, multiplierBin) {
	...
	pencilInit();
	initStepNumber(1);
	pencilTotSteps(multiplicandBin, multiplierBin);
